...
/**
 * @description: 组织删除事件监听
 **/
@Slf4j
@Component
@RequiredArgsConstructor
public class OrgDeleteEvent implements EventListener<ISVEventExtendDto> {
    ...
    public Set<String> supportTypes() {
        return Sets.newHashSet(IsvEventExtendType.BASE_ORG_EVENT_DELETE_AFTER);
    }
