...
/**
 * @description: 组织新增事件监听
 **/
@Slf4j
@Component
@RequiredArgsConstructor
public class OrgAddEvent implements EventListener<ISVEventExtendDto> {
    ...
    public Set<String> supportTypes() {
        return Sets.newHashSet(IsvEventExtendType.BASE_ORG_EVENT_ADD_AFTER);
    }
