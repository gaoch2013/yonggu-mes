...
/**
 * @description: 组织更新事件监听
 **/
@Slf4j
@Component
@RequiredArgsConstructor
public class OrgUpdateEvent implements EventListener<ISVEventExtendDto> {
    ...
    public Set<String> supportTypes() {
        return Sets.newHashSet(IsvEventExtendType.BASE_ORG_EVENT_UPDATE_AFTE);
    }
