...
/**
 * @description: 组织启用事件监听
 **/
@Slf4j
@Component
@RequiredArgsConstructor
public class OrgEnableEvent implements EventListener<ISVEventExtendDto> {
    ...
    public Set<String> supportTypes() {
        return Sets.newHashSet(IsvEventExtendType.BASE_ORG_EVENT_ENABLE_AFTE);
    }
