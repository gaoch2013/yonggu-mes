 ...
 */
@Component
public class MaterialOutService extends BaseOpenApi {
    ...
    public ApiDataPageResponse list(Map<String,Object> params) {
        ...
        ApiDataArrayResponse apiDataResponse =  postForEntity(OpenApiURL.MATERIAL_OUT_QUERY,params, ApiDataArrayResponse.class);
    ...
    public Map<String, Object> detail(Map<String,String> params) {
        ApiDataResponse apiDataResponse = getForEntity(OpenApiURL.MATERIAL_OUT_DETAIL,params, ApiDataResponse.class);
        return getData(apiDataResponse);
    }
    ...
    public Map<String, Object> save(Object params) {
        ApiDataResponse apiDataResponse = postForEntity(OpenApiURL.MATERIAL_OUT_SAVE, params, ApiDataResponse.class);
        return getData(apiDataResponse);
    }
}
