 ...
 */
@Component
public class RoutingService extends BaseOpenApi {
...
//        ApiDataResponse apiDataResponse = postForEntity(OpenApiURL.ROUTING_SAVE, params, ApiDataResponse.class);
...
//    }
    ...
    public ApiDataPageResponse list(Map<String, Object> params) {
        ...
        ApiDataArrayResponse apiDataResponse = postForEntity(OpenApiURL.ROUTING_LIST, params, ApiDataArrayResponse.class);
        return getData(apiDataResponse);
    }
    ...
    public Map<String, Object> detail(Map<String, String> params) {
        ApiDataResponse apiDataResponse = getForEntity(OpenApiURL.ROUTING_DETAIL, params, ApiDataResponse.class);
        return getData(apiDataResponse);
    }
