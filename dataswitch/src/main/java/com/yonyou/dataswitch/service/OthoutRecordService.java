 ...
 */
@Component
public class OthoutRecordService extends BaseOpenApi {
    ...
    public ApiDataPageResponse list(Map<String,Object> params) {
        ...
        ApiDataArrayResponse apiDataResponse =  postForEntity(OpenApiURL.OTHER_OUT_RECORD_QUERY,params, ApiDataArrayResponse.class);
    ...
    public Map<String, Object> detail(Map<String,String> params) {
        ApiDataResponse apiDataResponse = getForEntity(OpenApiURL.OTHER_OUT_RECORD_DETAIL,params, ApiDataResponse.class);
        return getData(apiDataResponse);
    }
    /**
     * 保存其他出库单
    ...
    public Map<String, Object> save(Object params) {
        ApiDataResponse apiDataResponse = postForEntity(OpenApiURL.OTHER_OUT_RECORD_SAVE, params, ApiDataResponse.class);
        return getData(apiDataResponse);
    }
}
